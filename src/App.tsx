          ...
          <div className="max-w-6xl mx-auto text-center space-y-12">
            ...
            >
              ...
              <div className="pt-8 flex flex-col items-center gap-6">
                <button className="bg-brand-primary text-white px-12 py-5 rounded-full text-xl font-medium hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-4">
                  Request Access
